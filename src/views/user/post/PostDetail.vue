...
<template #title>
	<div class='project_infor-title'>
		...
		<a href='#' class="project_infor-more">Xem 864 tin đăng bán ></a>
				...
				<!-- end::Project Infor  -->
				<a-divider />
				<div style="width: 100%"><iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=300&amp;hl=en&amp;q=H%C3%A0%20N%E1%BB%99i+(QT%20Land)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps trackers</a></iframe></div>
				<!-- begin::Date -->
				<!-- begin::Tag -->
